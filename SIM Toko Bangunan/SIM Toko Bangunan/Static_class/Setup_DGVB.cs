...
namespace SIM_Toko_Bangunan.Static_class
{
    class DGVB
    {
            public static void Setup_DGVB(DataGridView dgv, BindingSource bs)
            {
                try
                {
                    if (!(bs.Count > 0))
                    ...
                    {
                        col.HeaderCell.Style.Font = new Font("Microsoft Sans Serif", 12.0F, FontStyle.Bold, GraphicsUnit.Pixel);
